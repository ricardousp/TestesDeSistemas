...
public class UsuarioSystemTest {
	...
	/* Defeito encontrado na aplicação:
	<table>
	 	<tbody>
			<tr>
				<th>Nome</th>
	...
	* Forma Correta:	
	...
	Na prática deveríamos reportar esse bug e não deveríamos modificar o nosso testes, 
	mas para efeitos didáticos vamos modificar o teste para ele poder passar...
